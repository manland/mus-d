...
\section{Contraintes}
	...
	\indent En outre, les jeux créés à partir du framework doivent être jouables sur internet et sur tous types de système d'exploitation.  Enfin, nos application seront également capables de tourner en dehors d'un explorateur internet. \\
	\indent Nous avons décidé d'implémenter nos classes sous la forme du modèle MVC (Model Controler View).
...
\section{Outils de travail}
	...
	\subsection{Modélisation UML}
		\indent Nous utiliserons le logiciel BOUML pour modéliser l'architecture du framework car il est simple d'utilisation, multi-plateformes et gratuit.
